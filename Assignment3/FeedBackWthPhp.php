...
<head>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#TxtName").keypress(function (e) {
                $("#TxtNameValidation").empty();
                var Flag = ((e.which >= 65 && e.which <= 90) || (e.which >= 97 && e.which <= 121) || (e.which === 32));
                if (Flag == false) {
            ...
            $("#BtnSubmit").submit(function (e) {
                e.preventDefault();
                var TxtNameFlag = false, TxtEmailIdFlag = false, TxtContactMsgFlag = false;
                $("#TxtNameValidation").empty();
                ...
                if (TxtNameFlag == true && TxtEmailIdFlag == true && TxtContactMsgFlag == true) {
                    $("input,textarea").val("");
    ...
    <style>
        ...
        .main2 {
            ...
            box-shadow: 0px 0px 20px rgb(15, 137, 203);
            border-radius: 4px;
        ...
        .submit-btn {
            ...
            border-radius: 6px;
            cursor: pointer;
            background: rgb(74, 99, 106);
            border: 2px solid rgb(74, 99, 106);
            transition: all 0.3s ease;
        }
...
<body>
    <div class="main3">
        <div class="main2">Feedback</div>
        <div>
            <div class="main1">
                <form method="post" action="FeedBackDbms.php">
                    <div class="fields">
                        <div class="field">
                            <input type="text" name="Text" id="TxtName" class="input" placeholder="Name">
                            <small id="TxtNameValidation"></small>
                        </div>
                        <div class="field">
                            <input type="text" name="email" id="TxtEmailId" class="input" placeholder="Email">
                            <small id="TxtEmailIdValidation"></small>
                        </div>
                    </div>
                    <div class="field">
                        <!-- <textarea class="textarea" name="Msg" id="TxtContactMsg" placeholder="Message"></textarea> -->
                        <input type="text" name="Msg" id="TxtContactMsg" class="input" placeholder="Name">
                        <small id="TxtContactMsgValidation"></small>
                    </div>
                    <div class="button-area">
                        <input type="submit" id="BtnSubmit"     
                          class="submit-btn">
                        <!-- <button type="submit" name="submit" id="BtnSubmit" class="submit-btn">Send message</button> -->
                    </div>
                </form>
            </div>
        </div>
